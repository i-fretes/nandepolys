      ...
      if (existsSync(this.dataFile)) {
        try {
          ...
          for (const r of raw) {
            ...
            r.state.usedContent ??= {}; r.state.rentDice ??= null; delete (r.state as unknown as Record<string, unknown>).speedDie; delete (r.state.settings as unknown as Record<string, unknown>).speedDie;
