...
export const CHANCE_CARDS: Card[] = [
  ...
  { id: 'S2', deck: 'chance', text: 'Viaje de compras a Ciudad del Este. Si pasás por Salida, cobrá ₲ 200.000.', effect: { kind: 'moveTo', tile: 26, collectGo: true } },
  { id: 'S3', deck: 'chance', text: 'Te invitaron a un asado en Coronel Oviedo. Si pasás por Salida, cobrá ₲ 200.000.', effect: { kind: 'moveTo', tile: 12, collectGo: true } },
  ...
  { id: 'S14', deck: 'chance', text: 'Recepción en el Palacio de López. Avanzá hasta ahí.', effect: { kind: 'moveTo', tile: 43, collectGo: false } },
