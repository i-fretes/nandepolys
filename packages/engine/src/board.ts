...
export const BOARD: Tile[] = [
  ...
  street(6, 'Caacupé', 'celeste', 100, [6, 30, 90, 270, 400, 550], 50),
  { id: 7, type: 'chance', name: 'Suerte' },
  street(8, 'Paraguarí', 'celeste', 100, [6, 30, 90, 270, 400, 550], 50),
  street(9, 'Villarrica', 'celeste', 120, [8, 40, 100, 300, 450, 600], 50),
  { id: 10, type: 'jail', name: 'Tacumbú' },
  street(11, 'Coronel Oviedo', 'rosa', 140, [10, 50, 150, 450, 625, 750], 100),
  { id: 12, type: 'utility', name: 'ANDE', price: 150 },
  street(13, 'Concepción', 'rosa', 140, [10, 50, 150, 450, 625, 750], 100),
  street(14, 'Pilar', 'rosa', 160, [12, 60, 180, 500, 700, 900], 100),
  { id: 15, type: 'transport', name: 'Aeropuerto Silvio Pettirossi', price: 200 },
  street(16, 'Luque', 'naranja', 180, [14, 70, 200, 550, 750, 950], 100),
  { id: 17, type: 'community', name: 'Cooperativa' },
  street(18, 'San Lorenzo', 'naranja', 180, [14, 70, 200, 550, 750, 950], 100),
  street(19, 'Fernando de la Mora', 'naranja', 200, [16, 80, 220, 600, 800, 1000], 100),
  { id: 20, type: 'parking', name: 'Estacionamiento Libre' },
  street(21, 'Encarnación', 'rojo', 220, [18, 90, 250, 700, 875, 1050], 150),
  { id: 22, type: 'chance', name: 'Suerte' },
  street(23, 'Pedro Juan Caballero', 'rojo', 220, [18, 90, 250, 700, 875, 1050], 150),
  street(24, 'Ciudad del Este', 'rojo', 240, [20, 100, 300, 750, 925, 1100], 150),
  { id: 25, type: 'transport', name: 'Puerto de Asunción', price: 200 },
  street(26, 'Av. Mariscal López', 'amarillo', 260, [22, 110, 330, 800, 975, 1150], 150),
  street(27, 'Av. España', 'amarillo', 260, [22, 110, 330, 800, 975, 1150], 150),
  { id: 28, type: 'utility', name: 'ESSAP', price: 150 },
  street(29, 'Av. Aviadores del Chaco', 'amarillo', 280, [24, 120, 360, 850, 1025, 1200], 150),
  { id: 30, type: 'gotojail', name: 'Vaya a Tacumbú' },
  street(31, 'Villa Morra', 'verde', 300, [26, 130, 390, 900, 1100, 1275], 200),
  street(32, 'Las Carmelitas', 'verde', 300, [26, 130, 390, 900, 1100, 1275], 200),
  { id: 33, type: 'community', name: 'Cooperativa' },
  street(34, 'Mburucuyá', 'verde', 320, [28, 150, 450, 1000, 1200, 1400], 200),
  { id: 35, type: 'transport', name: 'Puente de la Amistad', price: 200 },
  { id: 36, type: 'chance', name: 'Suerte' },
  street(37, 'Costanera de Asunción', 'azul', 350, [35, 175, 500, 1100, 1300, 1500], 200),
  { id: 38, type: 'tax', name: 'Impuesto al lujo', amount: 100 },
  street(39, 'Palacio de López', 'azul', 400, [50, 200, 600, 1400, 1700, 2000], 200),
];
